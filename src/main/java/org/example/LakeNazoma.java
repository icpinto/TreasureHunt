...
public class LakeNazoma {
    ...
    public static int[][] warriorsLocation = new int[1][1];
    public static int[][] lotusLocation= new int[1][1];
    public static int[][] killerFishLocation= new int[1][1];
    public static int[][] ruberEaterLocation= new int[1][1];
